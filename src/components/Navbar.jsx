...
const handleNav = () => {
    ...
    return (
        <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto text-white px-4'>
            ...
            <div className={!nav ? 'fixed z-[30] left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-slate-950 bg-opacity-90 ease-out duration-500 md:hidden' : 'fixed left-[-100%]'}>
